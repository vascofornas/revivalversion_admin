...
$from_email = 'superadmin@miasesorautomotriz.com'; //Webmaster email
$from_name = 'Test Email'; //"From name" displayed on email

//Find specific server settings at https://www.arclab.com/en/kb/email/list-of-smtp-and-pop3-servers-mailserver-list.html
$mailServerType = 'smtp';
//IF $mailServerType = 'smtp'
$smtp_server = 'mail.miasesorautomotriz.com';
$smtp_user = 'superadmin@miasesorautomotriz.com';
$smtp_pw = 'Papa020432';
$smtp_port = 26; //465 for ssl, 587 for tls, 25 for other
